...
from geonurse.tools.topology import _return_duplicated_exterior_coords
from geonurse.tools.topology import exterior_duplicates
from geonurse.tools.topology import _geom_with_interiors
from geonurse.tools.topology import _interior_duplicates_bool
from geonurse.tools.topology import _return_duplicated_interior_coords
from geonurse.tools.topology import interior_duplicates
from geonurse.tools.topology import _linestring_duplicates_bool
from geonurse.tools.topology import _return_duplicated_linestring_coords
from geonurse.tools.topology import linestring_duplicates
...
def test_exterior_duplicates_bool(test_data_polygon_exterior_duplicates_gdf):
    _, geoseries = test_data_polygon_exterior_duplicates_gdf
...
def test_return_duplicated_exterior_coords(test_data_polygon_exterior_duplicates_gdf):
    _, geoseries = test_data_polygon_exterior_duplicates_gdf
    for i in range(0, len(geoseries)):
        if i in [0, 3, 6, 9, 12, 19]:
...
def test_exterior_duplicates(test_data_polygon_exterior_duplicates_gdf):
    _, geoseries = test_data_polygon_exterior_duplicates_gdf
...
def test_geom_with_interiors(test_data_polygon_interior_duplicates_gdf):
    _, geoseries = test_data_polygon_interior_duplicates_gdf
...
def test_interior_duplicates_bool(test_data_polygon_interior_duplicates_gdf):
    _, geoseries = test_data_polygon_interior_duplicates_gdf
...
def test_return_duplicated_interior_coords(test_data_polygon_interior_duplicates_gdf):
    _, geoseries = test_data_polygon_interior_duplicates_gdf
...
def test_interior_duplicates(test_data_polygon_interior_duplicates_gdf):
    _, geoseries = test_data_polygon_interior_duplicates_gdf
...
def test_linestring_duplicates_bool(test_data_linestring_duplicates_gdf):
    _, geoseries = test_data_linestring_duplicates_gdf
    new_geoseries = _return_affected_geoms(geoseries,
...
def test_return_duplicated_linestring_coords(test_data_linestring_duplicates_gdf,
                                             expected_linestring_duplicates_gdf):
    _, test_geoseries = test_data_linestring_duplicates_gdf
    _, expected_geoseries = expected_linestring_duplicates_gdf
...
def test_linestring_duplicates(test_data_linestring_duplicates_gdf,
                               expected_linestring_duplicates_gdf):
    _, test_geoseries = test_data_linestring_duplicates_gdf
    _, expected_geoseries = expected_linestring_duplicates_gdf
...
def test_overlaps(test_data_overlaps_gdf,
                  expected_overlaps_gdf):
    test_gdf, _ = test_data_overlaps_gdf
    expected_gdf, _ = expected_overlaps_gdf
